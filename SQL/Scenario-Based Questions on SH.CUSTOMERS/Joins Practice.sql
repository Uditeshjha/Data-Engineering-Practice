...
-- INNER JOIN = Common records from Clients and Orders tables
SELECT 
    c.Client_ID,
    c.Full_Name,
    o.Item_Name,
...
--  LEFT OUTER JOIN = All data from Clients + Matching data from Orders
SELECT 
    c.Client_ID,
    c.Full_Name,
    o.Item_Name,
...
--  RIGHT OUTER JOIN = All data from Orders + Matching data from Clients
SELECT 
    c.Client_ID,
    c.Full_Name,
    o.Item_Name,
...
--  SYMMETRIC DIFFERENCE = (A U B) - (A intersect B) 
