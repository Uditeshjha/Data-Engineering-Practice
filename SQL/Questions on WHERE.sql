...
-- select * from sh.CUSTOMERS where CUST_CREDIT_LIMIT = 0
...
-- CUST_INCOME_LEVEL like 'G%' or CUST_INCOME_LEVEL like 'H%'
...
-- 18. Find customers whose effective start date (`CUST_EFF_FROM`) 
-- is after 2020.
-- select * from sh.CUSTOMERS where CUST_EFF_FROM > TO_DATE('31,12,2020','DD-MM-YYYY')

-- 19. Retrieve customers whose effective end date (`CUST_EFF_TO`) 
-- is before 2021.
-- select * from sh.CUSTOMERS where CUST_EFF_TO < TO_DATE('01,01,2021','DD-MM-YYYY')
...
-- 25. Retrieve customers who either do not have email or do not have 
-- a credit limit.
-- select * from sh.CUSTOMERS where CUST_EMAIL is null or CUST_CREDIT_LIMIT = 0